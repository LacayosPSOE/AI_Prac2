...
public class FSM_Skeleton_Scare : FiniteStateMachine
{
    ...
    public override void OnConstruction()
    {
        ...
        Transition guideClose = new Transition("Chase_Guide",
            () =>
            {
                return blackboard.timer <= 0 &&
                       SensingUtils.DistanceToTarget(gameObject, blackboard.guide) <= blackboard.scareRange;
            },
            () => { }
        );
        ...
        AddTransition(chasingPaladin, guideClose, scareGuide);
